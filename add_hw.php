...
<body>
  ...
  `Homeworkdimg` varchar(255) NOT NULL,
  `HomeworkId` varchar(255) NOT NULL,
  `Homeworkdocuments` varchar(255) NOT NULL,
  `hwtittle` varchar(255) DEFAULT NULL,
  `homeworkdescription` varchar(225) DEFAULT NULL,
  `vedioid` varchar(255) DEFAULT NULL -->
